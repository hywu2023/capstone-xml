...
public class MedRecord extends AppCompatActivity {
    ...
    String[] items = { "감기약", "두통약", "저녁약"}; // 약 이름 자동
...
//        -----------------------------------------------//
        ...
        // 10-22 알림 이름 자동완성
        final AutoCompleteTextView nameEdit = (AutoCompleteTextView) findViewById(R.id.nameEdit);
        nameEdit.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, items));
